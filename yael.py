...
class malloc_stats_t(_object):
    ...
    if _newclass:n_alloc = _swig_property(_yael.malloc_stats_t_n_alloc_get, _yael.malloc_stats_t_n_alloc_set)
    __swig_setmethods__["n_free"] = _yael.malloc_stats_t_n_free_set
    __swig_getmethods__["n_free"] = _yael.malloc_stats_t_n_free_get
    if _newclass:n_free = _swig_property(_yael.malloc_stats_t_n_free_get, _yael.malloc_stats_t_n_free_set)
    ...
    if _newclass:n_realloc = _swig_property(_yael.malloc_stats_t_n_realloc_get, _yael.malloc_stats_t_n_realloc_set)
    ...
    if _newclass:delta_alloc = _swig_property(_yael.malloc_stats_t_delta_alloc_get, _yael.malloc_stats_t_delta_alloc_set)
    ...
    if _newclass:max_alloc = _swig_property(_yael.malloc_stats_t_max_alloc_get, _yael.malloc_stats_t_max_alloc_set)
    ...
    if _newclass:n_untracked_frees = _swig_property(_yael.malloc_stats_t_n_untracked_frees_get, _yael.malloc_stats_t_n_untracked_frees_set)
    def __init__(self): 
